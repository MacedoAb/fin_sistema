						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$funcionarios ?>"><a href="funcionarios"><i class="fa fa-user"></i> Funcionários</a></li>

									<li class="<?php echo @$fornecedores ?>"><a href="fornecedores"><i class="fa fa-file-text"></i> Fornecedores</a></li>
							...
							<li class="treeview <?php echo @$menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$formas_pgto ?>"><a href="formas_pgto"><i class="fa fa-dollar"></i> Formas Pgto</a></li>
									...
									<li class="<?php echo @$grupo_acessos ?>"><a href="grupo_acessos"><i class="fa fa-file-word-o"></i> Grupos</a></li>

									<li class="<?php echo @$acessos ?>"><a href="acessos"><i class="fa fa-file-archive-o"></i> Acessos</a></li>
							...
							<li class="treeview <?php echo @$menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo @$receber ?>"><a href="receber"><i class="fa fa-bitcoin"></i> Receitas</a></li>
